...
lines = [RKF45, M1, M4_GL, M2, WKB, JMlknum]
...
def plot_graph():
	...
	if Eq == Airy:
		lgnd = ax0.legend(fontsize=legend_font_size, loc='upper center', bbox_to_anchor=(0.27, 0.88, 0.50, 0.25), ncol = 2, shadow=False)
	elif Eq == burst:
		lgnd = ax0.legend(fontsize=legend_font_size, loc='upper center', bbox_to_anchor=(0.25, 0.88, 0.50, 0.25), ncol = 2, shadow=False)
