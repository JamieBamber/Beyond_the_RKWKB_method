...
JM1l = {
	"name" : "Jordan-Magnus ($\\Lambda$ only)",
	"fname" : "JM1l",
	"order" : 2,
	"analytic" : True
}
...
JM1lk = {
	"name" : "Jordan-Magnus ($\\Lambda$ and $K$)",
	"fname" : "JM1lk",
	"order" : 2,
	"analytic" : True
}
...
title = Eq["title"] + " : WKB vs Jordan-Magnus" # $x_i$ index = " + str(Index)
...
plt.minorticks_on()
plt.legend(ncol = 1, fontsize=legend_font_size)
