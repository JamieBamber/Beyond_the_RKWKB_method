...
def g(t):
	return (sym.exp(-t**2/49))
	
def g_num(t):
	return (np.exp(-t**2/49))
...
lines = [EPWKB, PWKB, JM1l, JM1lk] #, JM1lk, JM1l]
...
def Jordan_WKB():
	Use_numerics = JWKB["analytic"] 			# how much to use numerics instead of symbolics. 0 = minimum, 1 = Some, 2 = maximum
