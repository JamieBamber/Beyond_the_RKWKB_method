...
n_steps = 500
t_vec = np.linspace(-n_burst, n_burst, n_steps)
t_vec0 = np.linspace(-n_burst, n_burst, 1000)
...
filename = "Burst_order_1_" + str(n_steps) + "_steps"
...
plt.plot(t_vec, x[:,0], 'rx', markersize=1, linewidth=1, label="Magnus stepping")
